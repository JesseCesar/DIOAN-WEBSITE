...
const LocationSection = () => {
  return (
    <div className="bg-white rounded-lg p-8 md:p-12 font-poppins flex justify-center items-center flex-col">
      <h2 className="text-3xl font-bold mb-4 text-gray-900 text-center">Our Location</h2>
      <p className="text-gray-700 text-lg mb-4 text-center">Avenida 21 de Janeiro Luanda (Morro-Bento)</p>
      <iframe
        className="w-3/4 h-64 rounded-lg"
